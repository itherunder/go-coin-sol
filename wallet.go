...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/itherunder/go-random"
	"slices"
	"strconv"
	"strings"
	"time"
	...
	go_format_string "github.com/itherunder/go-format/string"
	go_http "github.com/itherunder/go-http"
	i_logger "github.com/itherunder/go-interface/i-logger"
	go_time "github.com/itherunder/go-time"
	...
	for {
		...
		case <-confirmTimer.C:
			...
			if err != nil || getTransactionResult_ == nil {
				...
				// t.logger.InfoF("未确认...")
				confirmTimer.Reset(checkInterval)
				continue
			}
